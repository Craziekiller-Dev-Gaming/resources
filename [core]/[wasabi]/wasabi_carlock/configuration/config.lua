...
'L'                                                                                            -- Which key to register as toggle of vehicle locks?
...
Config.givingKeys        = { -- Giving keys options (only with metadata keys disabled)
    ...
    removeKey = false,        -- Remove the key to vehicle from person giving key
    menuPosition =
...
Config.lockpick          = {
    ...
    item = 'lockpick',
    chanceOfLoss = 15, -- Chance of bending lockpick and losing item
    difficulties = {
...
Config.searchingVehicle  = {                                                                     -- Vehicle search options
    ...
    rewards = {                                                                                  -- Obtainable random items
        [1] = { chance = 50, type = 'account', name = 'money', quantity = math.random(5, 50) }, -- Example of money as reward
