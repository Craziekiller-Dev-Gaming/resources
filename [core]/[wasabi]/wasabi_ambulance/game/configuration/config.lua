...
Config.Bandages = {
    ...
    hpRegen = 11,          -- Percentage of health it replenishes (30% by default)
...
Config.ReviveRewards = {
    ...
    no_injury = 25,         -- If above enabled, how much reward for fully treated patient with no injury in diagnosis
    burned = 25,            -- How much if player is burned and revived without being treated
    beat = 25,              -- So on, so forth
    stabbed = 25,
    bleedout = 25,          -- NEW
    shot = 25,
}
...
Config.Locations = {
    Pillbox = {
        RespawnPoint = { -- When player dies and bleeds out; they will revive at nearest hospital; Define the coords of this hospital here.
            coords = vector3(-466.91, -291.34, 35.84),
            heading = 332.22,
        ...
        Blip = {
            Enabled = true,
            Coords = vector3(-448.44, -339.86, 34.5),
            Sprite = 561,
            Color = 0,
            Scale = 1.0,
        ...
        clockInAndOut = {
            ...
            coords = vector3(-432.39, -318.64, 34.91), -- Location of where to go on and off duty(If not using target)
            ...
            target = {
                ...
                coords = vector3(-432.39, -318.64, 34.91),
                heading = 337.07,
                width = 2.0,
                length = 1.0,
                minZ = 43.28 - 0.9,
        ...
        PersonalLocker = {
            ...
            coords = vector3(-443.92, -309.46, 35.35),   -- Location of where to access personal locker (If target is disabled)
            ...
            target = {
                enabled = false,                    -- If enabled, the location and distance above will be obsolete
                label = 'Access Locker',
                coords = vector3(-443.92, -309.46, 35.35),
                heading = 70.18,
                width = 2.0,
                length = 1.0,
                minZ = 43.38 - 0.9,
        ...
        BossMenu = {
            ...
            Coords = vector3(-455.25, -320.35, 34.91), -- Location of boss menu (If not using target)
            ...
            Target = {
                ...
                coords = vector3(-455.25, -320.35, 34.91),
                heading = 269.85,
                width = 2.0,
                length = 1.0,
                minZ = 43.21 - 0.9,
        ...
        CheckIn = {                                      -- Hospital check-in
            ...
            Ped = 's_m_m_scientist_01',                  -- Check in ped
            Coords = vector3(-435.26, -324.17, 33.91), -- Coords of ped
            Distance = 4.85,                             -- Distance to show textUI (If target is not enabled below)
            ...
            Target = {
                enabled = true,                          -- Enable Target? (Can be customized in wasabi_bridge/customize/cl_customize.lua the target system)
                label = 'Check In',
                coords = vector3(-435.28, -324.15, 33.91),
                heading = 63.26,
                distance = 5.0,
                width = 2.0,
                length = 1.0,
            ...
            HospitalBeds = {
                --              { coords = vec3(332.62, -587.17, 42.84+0.3), heading = 160.0 },
                { coords = vector3(-466.91, -291.39, 34.84), heading = 200.34 },
                { coords = vector3(-463.64, -290.0, 34.83), heading = 200.15 },
                { coords = vector3(-460.26, -288.46, 34.83),  heading = 206.5 },
                { coords = vector3(-454.79, -286.35, 34.83), heading = 232.28 },
                { coords = vector3(-451.4, -285.09, 34.83), heading = 224.95 },
                { coords = vector3(-448.31, -283.63, 34.83), heading = 206.61 },
                { coords = vector3(-455.14, -278.18, 34.84), heading = 24.22 },
                { coords = vector3(-459.11, -279.7, 34.84),  heading = 25.17 },
                { coords = vector3(-462.78, -281.41, 34.84), heading = 22.41 },
                { coords = vector3(-466.58, -282.96, 34.84), heading = 25.45},
                { coords = vector3(-469.92, -284.43, 34.84),  heading = 23.85 },
        ...
        Cloakroom = {
            Enabled = true,
            Coords = vector3(-437.61, -308.8, 34.91), -- Coords of cloakroom
        ...
        MedicalSupplies = {                                                     -- EMS Shop for supplies
            ...
            Coords = vector3(-428.99, -318.56, 33.91),                       -- Coords of ped/target
        ...
        Vehicles = {                                   -- Vehicle Garage
            ...
            Zone = {
                coords = vector3(-485.64, -343.61, 34.14), -- Area to prompt vehicle garage
            ...
            Spawn = {
                land = {
                    coords = vector3(-485.59, -343.1, 34.14),
                    heading = 68.43
                },
                air = {
                    coords = vector3(-446.75, -314.25, 78.55),
                    heading = 289.29
                }
            },
            Options = {
