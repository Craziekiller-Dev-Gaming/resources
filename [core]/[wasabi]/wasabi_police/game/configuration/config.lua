...
Config.handcuff = {                             -- Config in regards to cuffing
    ...
    lockpicking = {                             -- Lockpicking someone else out of handcuffs
        ...
        difficulty = { 'easy', 'easy', 'medium' } -- Options: 'easy' / 'medium' / 'hard' (Can be stringed along as they are in config)
    }
}
...
Config.Locations = {
    LSPD = {
        blip = {
            enabled = true,
            coords = vec3(-561.957, -419.817, 30.69),
            sprite = 559,
            color = 0,
            scale = 1.0,
            string = 'Los Santos PD'
        },
        ...
        clockInAndOut = {
            ...
            coords = vec3(-585.37, -424.54, 34.45), -- Location of where to go on and off duty(If not using target)
            ...
            target = {
                ...
                coords = vec3(-585.37, -424.54, 34.45),
                heading = 91.06,
                distance = 2.5,
                width = 2.0,
                length = 1.0,
        ...
        bossMenu = {
            ...
            coords = vector3(-569.05, -418.82, 39.63), -- Location of boss menu (If not using target)
        ...
        armoury = {
            ...
            coords = vector3(-599.49, -412.77, 34.17),                                                  -- Coords of armoury
            heading = 267.26,                                                                             -- Heading of armoury NPC
            ped = 's_f_y_cop_01',                                                                        -- Ped model or false for no ped
            label = '[E] - Access Armoury',                                                              -- String of text ui
            target = {
                enabled = false,                   -- If enabled, the location and distance above will be obsolete
                label = 'Access Armoury',
                coords = vector3(-599.49, -412.77, 34.17), 
                heading = 24.95,
                distance = 4.0,
                width = 2.0,
                length = 1.0,
            ...
            weapons = {
                ...
                { name = 'uvlight' , label = 'UV Light', multiple = false, price = 10 },
                { name = 'armor', label = 'Armor', multiple = true, price = 250 },
                { name = 'heavyarmor', label = 'Heavy Armor', multiple = true, price = 1050 },
                { name = 'medikit', label = 'Medical Kit', multiple = true, price = 50 },
                { name = 'radio', label = 'Medical Kit', multiple = true, price = 50 },
                { name = 'mdt', label = 'Police MDT', multiple = false, price = 50 },
                ...
                { name = 'pistol_flashlight',     label = 'PD Pistol Flashlight',      multiple = false, price = 150 },
                { name = 'pistol_ammo' , label = 'Pistol Clip', multiple = true, price = 10 }, -- Set multiple to true if you want ability to purchase more than one at a time
                { name = 'weapon_pumpshotgun' , label = 'PD Shotgun', multiple = true, price = 10 },
                { name = 'shotgun_flashlight' , label = 'PD Shotgun Flashlight', multiple = true, price = 10 },
                { name = 'shotgun_ammo' , label = 'Shotgun Shells', multiple = true, price = 10 },
                { name = 'weapon_carbinerifle' , label = 'PD Rifle', multiple = true, price = 10 },
                { name = 'rifle_flashlight' , label = 'PD Rifle Flashlight', multiple = true, price = 10 },
                { name = 'rifle_ammo' , label = 'Rifle Clip', multiple = true, price = 10 },
                { name = 'weapon_smg' , label = 'PD Smg', multiple = true, price = 10 },
                { name = 'smg_ammo' , label = 'Smg Clip', multiple = true, price = 10 },
                { name = 'police_stormram' , label = 'Stormram', multiple = true, price = 10 },
                { name = 'handcuffs' , label = 'Handcuffs', multiple = false, price = 10 },
                { name = 'uvlight' , label = 'UV Light', multiple = false, price = 10 },
                { name = 'armor', label = 'Armor', multiple = true, price = 250 },
        ...
        personalLocker = {
            ...
            coords = vector3(-606.35, -418.53, 35.17), -- Area to prompt personal locker
