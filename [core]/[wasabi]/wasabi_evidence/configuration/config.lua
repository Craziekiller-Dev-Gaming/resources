...
-- Copy starting here to add new location
    LSPD = {
        ...
        analyze = {
            coords = vector3(-594.17, -433.81, 45.63), -- Coords for location(If target is not enabled)
            ...
            target = {
                ...
                coords = vector3(-594.17, -433.81, 45.63),
                heading = 181.42,
                width = 2.0,
                length = 1.0,
                minZ = 30.68-0.9,
        ...
        fingerprinting = {
            ...
            coords = vector3(-578.54, -435.56, 31.16), -- Coords for location(If target is not enabled)
            range = 1.8, -- Range to show TextUI (If target is not enabled)
        ...
        storage = {
            ...
            coords = vector3(-600.54, -430.44, 45.63), -- Coords for location(If target is not enabled)
            range = 1.8, -- Range to show TextUI (If target is not enabled)
