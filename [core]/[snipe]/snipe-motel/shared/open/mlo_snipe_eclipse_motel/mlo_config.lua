Config.LobbyCoords = vector4(-755.42, 315.2, 85.67, 55.06) -- if a player leaves the server while being in a room, he will be teleported to this location

Config.PedLocations = {
    [1] = {
        coords = vector4(-784.92, 325.15, 85.55, 270.65),
...
Config.Blip = {
    coords = vector3(-784.92, 325.15, 85.55),
    sprite = 183,
    color = 3,
    scale = 0.8,
    name = "Eclipse Motel",
