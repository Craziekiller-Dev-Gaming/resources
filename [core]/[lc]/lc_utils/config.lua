...
Config.custom_scripts_compatibility = {
	...
	['keys'] = "wasabi_carlock",						-- [qs-vehiclekeys|cd_garage|jaksam|wasabi_carlock|MrNewbVehicleKeys|default|other] Keys script Compatibility
	['mdt'] = "other",						-- [ps-mdt|redutzu-mdt|default|other] MDT script Compatibility (to log weapon serial)
