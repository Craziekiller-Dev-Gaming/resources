...
Config.fish_prices = {
	...
	['prices'] = {								-- The price ranges that will be set for each fish rarity
		...
		['rare'] = { min = 50, max = 100 },
		['legendary'] = { min = 200, max = 1000 },
		['mythic'] = { min = 2000, max = 5000 },
	}
}
...
Config.fishing_tournaments = {
	...
	["min_participants"] = 3,		-- Minimum participants required to start the tournament
	["event_duration"] = 5,			-- Duration of the tournament in minutes
