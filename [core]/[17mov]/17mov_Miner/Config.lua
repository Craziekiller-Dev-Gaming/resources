...
Config.PenaltyAmount = 200                         -- Penalty when team will not build every objects
Config.OnePercentWorth = 25                        -- A reward per one percent. Fully digged tunnel is 45 meters. Tags for searching: price, reward, money, cash
...
Config.ItemsWhileMining = {                         -- Here you can add some items that player can recive everytime that wall is hitted
    {
        chance = 20,                           -- Chance to get item. Must be between 0-100 (0 = 0% chance, 1 = 1% chance, 100 = 100% chance etc.)
        itemName = "rock",                   -- Name of item
        quantity = function(isOnBonus)        -- Must be a function
            return math.random(1, 1)          -- Must return number. In this case quantity is random from 1 to 5
        end,
    },
    {
        chance = 15,                           -- Chance to get item. Must be between 0-100 (0 = 0% chance, 1 = 1% chance, 100 = 100% chance etc.)
        itemName = "gold_ore",                   -- Name of item
        quantity = function(isOnBonus)        -- Must be a function
            return math.random(1, 1)          -- Must return number. In this case quantity is random from 1 to 5
        end,
    },
    {
        chance = 10,                           -- Chance to get item. Must be between 0-100 (0 = 0% chance, 1 = 1% chance, 100 = 100% chance etc.)
        itemName = "iron_ore",                   -- Name of item
        quantity = function(isOnBonus)        -- Must be a function
            return math.random(1, 1)          -- Must return number. In this case quantity is random from 1 to 5
        end,
    },
    {
        chance = 12,                           -- Chance to get item. Must be between 0-100 (0 = 0% chance, 1 = 1% chance, 100 = 100% chance etc.)
        itemName = "aluminum_ore",                   -- Name of item
        quantity = function(isOnBonus)        -- Must be a function
            return math.random(1, 1)          -- Must return number. In this case quantity is random from 1 to 5
        end,
    },
    {
        chance = 10,                           -- Chance to get item. Must be between 0-100 (0 = 0% chance, 1 = 1% chance, 100 = 100% chance etc.)
        itemName = "lead_ore",                   -- Name of item
        quantity = function(isOnBonus)        -- Must be a function
            return math.random(1, 1)          -- Must return number. In this case quantity is random from 1 to 5
        end,
    },
    {
        chance = 10,                           -- Chance to get item. Must be between 0-100 (0 = 0% chance, 1 = 1% chance, 100 = 100% chance etc.)
        itemName = "copper_ore",                   -- Name of item
        quantity = function(isOnBonus)        -- Must be a function
            return math.random(1, 1)          -- Must return number. In this case quantity is random from 1 to 5
        end,
    },
    {
        ...
        itemName = "emerald_ore",                   -- Name of item
        quantity = function(isOnBonus)        -- Must be a function
            return math.random(1, 1)          -- Must return number. In this case quantity is random from 1 to 5
        end,
    },
    {
        chance = 1,                           -- Chance to get item. Must be between 0-100 (0 = 0% chance, 1 = 1% chance, 100 = 100% chance etc.)
        itemName = "ruby_ore",                   -- Name of item
        quantity = function(isOnBonus)        -- Must be a function
            return math.random(1, 1)          -- Must return number. In this case quantity is random from 1 to 5
        end,
    },
    {
        chance = 0.5,                           -- Chance to get item. Must be between 0-100 (0 = 0% chance, 1 = 1% chance, 100 = 100% chance etc.)
        itemName = "diamond_ore",                   -- Name of item
        quantity = function(isOnBonus)        -- Must be a function
            return math.random(1, 1)          -- Must return number. In this case quantity is random from 1 to 5
        end,
    },
