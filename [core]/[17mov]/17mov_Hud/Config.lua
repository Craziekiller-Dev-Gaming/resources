-- { 17movement.net } --
Config = {}
Config.Autoinstall = false -- Automatic install to another scritps (qb-core, ex_extended)
Config.UseMPH = true
...
Config.MaxUnderwaterTime = 200.0
...
Config.DefaultSettings = {
    ...
    ['SpeedUnits'] = "mph",    -- Values: ['kmh', 'mph']. Default speed units. (NOTE: DO NO TOUCH! Sets automatically from Config.UseMPH)
