...
Config = {
    ...
    CharCreatorHasEverything = true, -- by default, char creator has only selected clothing for new players, if you want to have everything available, set this to true
    ...
    JobChangingRooms = {
        {
            ...
            pos = vector4(-598.81, -425.42, 35.17, 93.31),
            jobs = { 'police' },
        },
    },
    ...
    ClothingShops = {
		...
		},
        {
            label = 'PAY WOOL',
            type = 'paywool',
            blip = { title = "Pay Wool", colour = 46, id = 73 },
            pos = vector4(46.16, -825.31, 31.22, 29),
            config = SHOP_CONFIG_ALIAS.CLOTHING,
        },
        {
            label = 'PAY WOOL',
            type = 'paywool',
            pos = vector4(44.04, -824.70, 31.22, 337),
            config = SHOP_CONFIG_ALIAS.CLOTHING,
        },
        {
            label = 'PAY WOOL',
            type = 'paywool',
            pos = vector4(46.93, -819.80, 31.22, 60),
            config = SHOP_CONFIG_ALIAS.CLOTHING,
        },
    },
    ...
    -----------------------------------------------------
    Framework = 2, --[ 0 = AUTOMATIC, 1 = ESX / 2 = QBCore / 3 = Other ] Choose your framework
    ...
    UseFrameworkNotify = true, -- If true, framework notification will be used instead of UI notifications, recommended to leave at false as this script only needs to notify while in UI
