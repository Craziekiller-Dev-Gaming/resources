...
function Qc(e, n, t, r, l) {
    switch (n) {
        ...
        case 'gotpointercapture':
            return (
                (o = l.pointerId),
                It.set(o, ft(It.get(o) || null, e, n, t, r, l)),
                !0
            )
    }
    return !1
...
function eu(e, n, t, r) {
    if (Fr) {
        var l = fo(e, n, t, r)
        if (l === null) Il(e, n, r, jr, t), Gu(e, r)
        else if (Qc(l, e, n, t, r)) r.stopPropagation()
        else if ((Gu(e, r), n & 4 && -1 < Wc.indexOf(e))) {
            for (; l !== null; ) {
                var o = qt(l)
                if (
                    (o !== null && Ps(o),
...
var ot = {
    ...
    tl = A({}, Jt, {
        ...
        movementX: function (e) {
            return 'movementX' in e
                ...
                : (e !== pt &&
                      (pt && e.type === 'mousemove'
                          ? ((Nl = e.screenX - pt.screenX),
                            (Pl = e.screenY - pt.screenY))
                          : (Pl = Nl = 0),
                      (pt = e)),
                  Nl)
        },
    ...
    Jc = ge(Zc),
    qc = A({}, Jt, { relatedTarget: 0 }),
    zl = ge(qc),
    bc = A({}, ot, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    ef = ge(bc),
    nf = A({}, ot, {
...
var af = A({}, Jt, {
    ...
    pf = ge(df),
    mf = A({}, ot, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    vf = ge(mf),
    hf = A({}, tl, {
        deltaX: function (e) {
            return 'deltaX' in e
...
var go = typeof setTimeout == 'function' ? setTimeout : void 0,
    ...
    Uf =
        typeof queueMicrotask == 'function'
            ...
            : typeof pi < 'u'
            ? function (e) {
                  return pi.resolve(null).then(e).catch($f)
              }
            : go
function $f(e) {
    setTimeout(function () {
...
function xo(e, n, t, r) {
    var l = e.stateNode
    ;(l.props = t), (l.state = e.memoizedState), (l.refs = ra), pu(e)
    var o = n.contextType
    typeof o == 'object' && o !== null
        ? (l.context = Ce(o))
...
function mu(e, n) {
    switch ((M(Ht, n), M(Bt, e), M(je, bt), (e = n.nodeType), e)) {
        case 9:
        case 11:
...
function Ea(e, n, t) {
    return (Pn & 21) === 0
        ? (e.baseState && ((e.baseState = !1), (ae = !0)),
          (e.memoizedState = t))
        : (Oe(t, n) ||
              ((t = xs()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
          n)
}
function Qf(e, n) {
    var t = O
...
function zo(e, n, t, r, l, o) {
    ...
    return (
        (n.flags |= 1),
        e !== null && u
            ? ((n.child = et(n, e.child, null, o)),
              (n.child = et(n, null, i, o)))
            : le(e, n, i, o),
...
function Oi(e, n, t, r, l) {
    return bn(), su(l), (n.flags |= 256), le(e, n, t, r), n.child
}
...
function bf(e, n, t, r, l, o, u) {
    ...
    if (((i = (u & e.childLanes) !== 0), ae || i)) {
        ...
        return zu(), (r = Bl(Error(y(421)))), vr(e, n, u, r)
    }
    return l.data === '$?'
        ? ((n.flags |= 128),
          (n.child = e.child),
...
function ld(e, n) {
    ...
    for (
        ho = { focusedElem: e, selectionRange: t }, Fr = !1, S = n;
        S !== null;
...
function br(e, n) {
    ...
    while (1)
    if ((cu(), (R = t), (Zr.current = r), Q !== null)) throw Error(y(261))
    return (Z = null), (q = 0), Y
}
function sd() {
    for (; Q !== null; ) Ka(Q)
...
hs = Nu
ys = Ln
var kd = { usingClientEntryPoint: !1, Events: [qt, Un, ol, ms, vs, Nu] },
    ht = {
    ...
    Sd = {
        ...
        findFiberByHostInstance: ht.findFiberByHostInstance || gd,
 ...
 */ var Cd = Xt.exports,
    ...
    Pd =
        Cd.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function ec(e, n, t) {
    ...
    for (r in n) Nd.call(n, r) && !zd.hasOwnProperty(r) && (l[r] = n[r])
    if (e && e.defaultProps)
...
const $e = Du.exports.jsx,
    yt = Du.exports.jsxs
function Ld() {
    const [e, n] = Xt.exports.useState(0)
    return yt('div', {
        className: 'App',
        children: [
            yt('div', {
            ...
            yt('div', {
                ...
                children: [
                    ...
                    yt('p', {
                        children: [
                            'Edit ',
                            $e('code', { children: 'src/App.tsx' }),
                            ' and save to test HMR Halal',
                        ],
                    }),
                ],
            }),
