...
LuckyWheelRandomItems = {{
    inventoryName = "lockpick", -- item (inventory) name/key, case sensitive
    title = "Lockpick", -- title for the Lucky Wheel reward message
    amount = {1, 3}, -- amount (random between 1 to 10)
    possibility = 10
}, {
    inventoryName = "woodplanks", -- item (inventory) name/key, case sensitive
    title = "Wood Planks", -- title for the Lucky Wheel reward message
    amount = {50, 200},
    possibility = 10
}, {
    inventoryName = "repair_kit", -- item (inventory) name/key, case sensitive
    title = "Repair Kit", -- title for the Lucky Wheel reward message
    amount = 1, -- only 1
    possibility = 10
}, {
    inventoryName = "bandage", -- item (inventory) name/key, case sensitive
    title = "Bandage", -- title for the Lucky Wheel reward message
    amount = {5, 20},
    possibility = 10
}, {
    inventoryName = "metalscrap", -- item (inventory) name/key, case sensitive
    title = "Metal Scrap", -- title for the Lucky Wheel reward message
    amount = {10, 25},
    possibility = 10
}, {
    inventoryName = "plastic", -- item (inventory) name/key, case sensitive
    title = "Plastic", -- title for the Lucky Wheel reward message
    amount = {10, 25},
    possibility = 10
}, {
    inventoryName = "aluminum", -- item (inventory) name/key, case sensitive
    title = "Aluminum", -- title for the Lucky Wheel reward message
    amount = {10, 25},
    possibility = 10
}, {
    inventoryName = "iron", -- item (inventory) name/key, case sensitive
    title = "Iron", -- title for the Lucky Wheel reward message
    amount = {10, 25},
    possibility = 10
}, {
    inventoryName = "steel", -- item (inventory) name/key, case sensitive
    title = "Steel", -- title for the Lucky Wheel reward message
    amount = {10, 25},
    possibility = 10
}, {
    inventoryName = "rubber", -- item (inventory) name/key, case sensitive
    title = "Rubber", -- title for the Lucky Wheel reward message
    amount = {10, 25},
    possibility = 10
}}
