Config = {
    ...
    UseOnlyMoney = true, -- set to true if you want to play with money only, without casino chips
    ...
    -- Cashier
    CASHIER_DAILY_BONUS = 750, -- daily visitor bonus that players can request at the Cashier, set to 0 if you don't want any daily bonuses. def: 1000
    CASHIER_VIP_PRICE = 75000, -- price of the VIP casino membership, def: 50000
