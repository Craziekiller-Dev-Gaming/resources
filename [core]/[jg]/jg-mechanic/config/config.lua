...
Config.Inventory = "qs-inventory" -- or "ox_inventory", "qb-inventory", "esx_inventory", "codem-inventory", "qs-inventory"
...
Config.SocietyBanking = "okokBanking" -- or "okokBanking", "fd_banking", "Renewed-Banking", "tgg-banking", "qb-banking", "qb-management", "esx_addonaccount"
...
Config.MechanicLocations = {
  ...
  risingsun = {
    ...
    locations = {
      ...
      {-- bay 2
      coords = vector3(-333.12, -129.67, 39.06),
      size = 6.5,
      showBlip = false,
    },
    {-- bay 3
      coords = vector3(-329.75, -122.12, 38.40),
      size = 6.5,
      showBlip = false,
    },
    {-- bay 4
      coords = vector3(-327.18, -114.47, 38.40),
      size = 6.5,
      showBlip = false,
    },
    {-- bay 5
      coords = vector3(-347.47, -122.55, 38.40),
      size = 6.5,
      showBlip = false,
    },
    {-- cruisin bay 1
    coords = vector3(-332.33, -1368.02, 31.47),
    size = 6.5,
    showBlip = false,
  },
      {
    ...
    vector4(-348.55, -128.80, 39.00, 69),
    },
    shops = {
      {
        name = "Servicing Supplies",
        coords = vector3(-339.66, -132.44, -3.24),
        size = 2.0,
        usePed = false,
  ...
  pdm = {
    ...
    locations = {
    {-- cruisin bay 1
    coords = vector3(-1021.47, -1432.57, 5.43),
    size = 6.5,
    showBlip = true,
    },
    {-- cruisin bay 2
    coords = vector3(-1023.06, -1423.85, 4.77),
    size = 6.5,
    showBlip = false,
    },
      {
    ...
    carLifts = { -- only usable by employees
    vector4(-1034.39, -1437.94, 5.43, 110)
    },
    shops = {
      {
        name = "Servicing Supplies",
  ...
  craftsmen = {
    ...
    {-- cruisin bay 2
    coords = vector3(-339.96, -1367.65, 30.88),
    size = 6.5,
    showBlip = false,
    },
    {-- cruisin bay 3
    coords = vector3(-347.65, -1367.71, 30.87),
    size = 6.5,
    showBlip = false,
    },
      {
    ...
    carLifts = { -- only usable by employees
    vector4(-348.83, -1351.68, 31.44, 89)
    },
    shops = {
      {
        name = "Servicing Supplies",
