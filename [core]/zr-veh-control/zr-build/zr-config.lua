...
zr_config.minimal_music_actions_key =  "LCONTROL"  -- Keybind to use mouse while minimal music player is opened.
zr_config.music_distance = 15                      -- Adjust distance to keep hearing music if you have music outside option enabled.
...
-- Camera Options 
zr_config.timecyclemodifier = "heliGunCam"
zr_config.timecyclestrength = 0.8
