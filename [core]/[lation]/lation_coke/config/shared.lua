return {
    ...
    growth = {
        ...
        watering = { item = 'ls_watering_can', min = 10.0, max = 15.0 },
    ...
    cooking = {
        ...
        table = {
            [1] = {
                ...
                required = {
                    { item = 'ls_coca_leaf', quantity = 10, remove = true },
                    -- Add your own additional items here if desired
            ...
            [2] = {
                ...
                penalty = 25,
                required = {
                    { item = 'ls_coca_ground', quantity = 3, remove = true },
                },
                add = {
            ...
            [5] = {
                ...
                add = {
                    { item = 'ls_cocaine_bag', min = 20, max = 40, metatype = 'purity' },
                },
                xp = { min = 2, max = 5 },
