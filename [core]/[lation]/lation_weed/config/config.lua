...
Config.Shop = {
    ...
    items = {
        ...
        [1] = { item = 'ls_watering_can', price = 15, label = 'Water', icon = 'droplet', min = 1, max = 99 },
        [2] = { item = 'ls_fertilizer', price = 20, label = 'Fertilizer', icon = 'burger', min = 1, max = 99 },
        [3] = { item = 'ls_plant_pot', price = 10, label = 'Plant Pot', icon = 'plant-wilt', min = 1, max = 99 },
        [4] = { item = 'ls_shovel', price = 275, label = 'Shovel', icon = 'trowel', min = 1, max = 99 },
        [5] = { item = 'ls_shears', price = 150, label = 'Shears', icon = 'scissors', min = 1, max = 1 },
        [6] = { item = 'ls_rolling_paper', price = 5, label = 'Rolling Paper', icon = 'joint', min = 1, max = 99 },
        [7] = { item = 'ls_empty_baggy', price = 5, label = 'Empty Baggy', icon = 'bag-shopping', min = 1, max = 99 },
        [8] = { item = 'ls_weed_table', price = 90000, label = 'Weed Table', icon = 'cannabis', min = 1, max = 99 },
        [9] = { item = 'ls_access_card', price = 30000, label = 'Access Card', icon = 'bag-shopping', min = 1, max = 1 },
...
Config.Growth = {
    ...
    starting = { thirst = 100, hunger = 100, quality = 100, growth = 0 },
    ...
    growth_increase = { min = 0.35, max = 0.45 },
    ...
    watering = { item = 'ls_watering_can', min = 18.0, max = 30.0 },
    ...
    fertilizing = { item = 'ls_fertilizer', min = 20.0, max = 35.0 },
...
Config.Table = {
    ...
    buds = {
        ...
        ['plain_jane'] = {
            ...
            remove_bud = { rolling = 1, bagging = 4},
            ...
            -- This allows you to make this action AFK or not
            max_actions = { rolling = 30, bagging = 30 },
            -- The amount of exp rewarded to player per roll or bag
            exp = {
                rolling = { min = 1, max = 30 },
                bagging = { min = 1, max = 30 }
            },
            -- The icon to represent this strain in the menu
            icon = 'fas fa-cannabis',
            -- The icon color for this strain (leave '' for none)
