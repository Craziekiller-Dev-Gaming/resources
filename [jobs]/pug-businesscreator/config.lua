...
------------------------------
---------- [BOOLS] ----------
Config.UsingNewQBCore = true -- If you are using an older qbcore server that has not been updated to the qbcore may 2024 2.0 version make this false. This mostly handles stashes for the inventory and the shops.
Config.UseProgressBar = "ox_lib" -- (CHANGE TRUE TO "ox_lib" IF YOU WANT TO USE THE OX_LIB PROGRESSBAR) If you dont have a progressbar in your server make this false.
Config.ShowBlipsOnMiniMapOnlyShortRange = false -- Make this false if you want blips on the minimap to be shown no matter how far you are from it.
