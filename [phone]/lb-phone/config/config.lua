...
Config.Companies.Services = {
    {
        job = "police",
        name = "Police",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/LSPD.png?raw=true",
    ...
    },
    {
        job = "ambulance",
        name = "Ambulance",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/medicallogo.jpg?raw=true",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
    ...
    {
        job = "rising",
        name = "Rising Sun Customs",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/risingsun.png?raw=true",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
    ...
    {
        job = "craftsmen",
        name = "Craftsmen Mechanic",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/crusincraftsmen.png?raw=true",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
    ...
    },
    {
        job = "burgershot",
        name = "Burgershot",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/burgershot.png?raw=true",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss", "driver"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "uwu",
        name = "uWu",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/Uwu_cafe_logo.png?raw=true",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss", "driver"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "pdm",
        name = "PDM",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/a6e28ccd-1104-4933-8176-3d384382d973.png?raw=true",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss", "driver"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        ...
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/mirrorparktavern.png?raw=true",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss", "driver"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "pizzathis",
        name = "Pizza This",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/pizzathis.png?raw=true",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss", "driver"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "atom",
        name = "Up N Atom",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/upnatom.png?raw=true",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss", "driver"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "snrbuns",
        name = "Snr Buns",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/snrbuns.png?raw=true",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss", "driver"}, -- ranks that can manage the company
        location = {
...
Config.Locations = { -- Locations that'll appear in the maps app.
    {
        position = vector2(-563.465, -419.817),
        name = "LSPD",
        description = "Los Santos Police Department",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/LSPD.png?raw=true",
    },
    {
        position = vector2(-469.957, -335.976),
        name = "Mount Zonah",
        description = "Mount Zonah Medical Hospital",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/medicallogo.jpg?raw=true",
    },
    {
        position = vector2(-331.202, -136.280),
        name = "Rising Sun Customs",
        description = "Rising Sun Customs",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/risingsun.png?raw=true",
    },
    {
        position = vector2(-326.677, -1352.744),
        name = "Craftsmen Mechanic",
        description = "Craftsmen Mechanic",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/crusincraftsmen.png?raw=true",
    },
    {
        position = vector2(-1180.321, -889.329),
        name = "Burgershot",
        description = "Burgershot",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/burgershot.png?raw=true",
    },
    {
        position = vector2(-572.514, -1069.207),
        name = "uWu Cafe",
        description = "uWu Cafe",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/Uwu_cafe_logo.png?raw=true",
    },
    {
        position = vector2(-1027.992, -1393.902),
        name = "PDM",
        description = "PDM",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/a6e28ccd-1104-4933-8176-3d384382d973.png?raw=true",
    },
    {
        position = vector2(1222.249, -413.720),
        name = "Mirror Park Tavern",
        description = "Mirror Park Tavern",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/mirrorparktavern.png?raw=true",
    },
    {
        position = vector2(795.427, -741.463),
        name = "Pizza This",
        description = "Pizza This",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/pizzathis.png?raw=true",
    },
    {
        position = vector2(88.079, 285.976),
        name = "Up N Atom",
        description = "Up N Atom",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/upnatom.png?raw=true",
    },
    {
        position = vector2(-509.170, -706.402),
        name = "Snr Buns",
        description = "Snr Buns",
        icon = "https://github.com/JustinHeagy/bamboofivemimages/blob/main/snrbuns.png?raw=true",
    },
}
...
Config.CityName = "Bamboo Bay" -- The name that's being used in the weather app etc.
...
Config.EmailDomain = "bamboobay.com"
